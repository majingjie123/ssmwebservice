...
public class ITextRenderer2 {
    ...
    public ITextRenderer2(float dotsPerPoint, int dotsPerPixel) {
        ...
        // 添加字体，以支持中文
        try {
            fontResolver.addFont(path + "simhei.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
            fontResolver.addFont(path + "ARIALUNI.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
            fontResolver.addFont(path + "KAITI.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
